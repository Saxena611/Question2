...
//Oauth Specific functions exported from API;
...
function getDetails()
{
    ...
    if (isset($_REQUEST['code'])) {
        ...
        $accessToken = curl($url,http_build_query($params));//Query to oauth
        ...
        return (json_decode($user));//json string to php variable
